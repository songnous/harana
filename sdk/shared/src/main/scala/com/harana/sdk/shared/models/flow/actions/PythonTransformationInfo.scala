...
object PythonTransformationInfo extends PythonTransformationInfo with UIActionInfo[PythonTransformationInfo] {
  def apply(pos: (Int, Int), color: Option[String] = None) = new PythonTransformationInfo {
