...
import com.harana.sdk.shared.models.flow.parameters.{ParameterGroup, Parameters, StringParameter}
...
object ReadTransformerInfo extends ReadTransformerInfo with UIActionInfo[ReadTransformerInfo] {
