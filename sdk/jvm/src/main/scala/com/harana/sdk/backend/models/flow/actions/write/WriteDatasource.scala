...
import com.harana.sdk.backend.models.flow.{ActionType1To0, ExecutionContext, Knowledge}
...
class WriteDatasource extends ActionType1To0[DataFrame] with WriteDatasourceInfo {
