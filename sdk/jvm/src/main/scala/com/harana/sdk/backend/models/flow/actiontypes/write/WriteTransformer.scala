...
import com.harana.sdk.shared.models.flow.actiontypes.write.WriteTransformerInfo
import org.apache.hadoop.fs.{FileSystem, Path}

import java.io.{File, IOException}
import java.net.URI

class WriteTransformer extends ActionTypeType1To0[Transformer] with WriteTransformerInfo {
