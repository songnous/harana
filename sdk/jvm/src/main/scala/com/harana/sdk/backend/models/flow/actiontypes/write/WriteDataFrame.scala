package com.harana.sdk.backend.models.flow.actiontypes.write

import com.harana.sdk.backend.models.flow._
import com.harana.sdk.backend.models.flow.actionobjects.dataframe.DataFrame
import com.harana.sdk.backend.models.flow.actiontypes.ActionTypeType1To0
import com.harana.sdk.backend.models.flow.actiontypes.exceptions.HaranaIOError
import com.harana.sdk.backend.models.flow.actiontypes.readwritedataframe.filestorage.DataFrameToFileWriter
import com.harana.sdk.backend.models.flow.actiontypes.readwritedataframe.googlestorage.DataFrameToGoogleSheetWriter
import com.harana.sdk.backend.models.flow.actiontypes.readwritedataframe.validators.{FilePathHasValidFileScheme, ParquetSupportedOnClusterOnly}
...
import com.harana.sdk.shared.models.flow.actiontypes.write.WriteDataFrameInfo
import org.apache.spark.sql.SaveMode

import java.io.IOException
import java.util.Properties

class WriteDataFrame extends ActionTypeType1To0[DataFrame] with WriteDataFrameInfo {
