...
trait Atomics extends js.Object {
  ...
  /**
    ...
    * Until this atomic action completes, any other read or write action against the array
    * will block.
    */
  ...
  /**
    ...
    * returning the original value. Until this atomic action completes, any other read or
    * write action against the array will block.
    */
  ...
  /**
    ...
    * expected value, returning the original value. Until this atomic action completes, any
    * other read or write action against the array will block.
    */
  ...
  /**
    ...
    * this atomic action completes, any other read or write action against the array will
    * block.
    */
  ...
  /**
    * Returns the value at the given position in the array. Until this atomic action completes,
    * any other read or write action against the array will block.
    */
  ...
  /**
    ...
    * returning the original value. Until this atomic action completes, any other read or write
    * action against the array will block.
    */
  ...
  /**
    ...
    * atomic action completes, any other read or write action against the array will block.
    */
  ...
  /**
    ...
    * value. Until this atomic action completes, any other read or write action against the
    * array will block.
    */
