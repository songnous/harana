...
/** A list of DataTransferItem objects representing items being dragged. During a drag action, each DragEvent has a dataTransfer property and that property is a DataTransferItemList. */
@js.native
