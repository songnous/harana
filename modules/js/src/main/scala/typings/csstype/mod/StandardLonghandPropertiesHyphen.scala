...
trait StandardLonghandPropertiesHyphen[TLength] extends js.Object {
  ...
  /**
    ...
    */
  var `aspect-ratio`: js.UndefOr[AspectRatioProperty] = js.undefined
  /**
  ...
  /**
    * The **`mask-composite`** CSS property represents a compositing action used on the current mask layer with the mask layers below it.
    *
    * **Initial value**: `add`
    *
    * | Chrome | Firefox | Safari |  Edge  | IE  |
  ...
  /**
    ...
    */
  var `overscroll-behavior-block`: js.UndefOr[OverscrollBehaviorBlockProperty] = js.undefined
  /**
    ...
    */
  var `overscroll-behavior-inline`: js.UndefOr[OverscrollBehaviorInlineProperty] = js.undefined
  /**
  ...
  /**
    ...
    */
  var `shape-image-threshold`: js.UndefOr[ShapeImageThresholdProperty] = js.undefined
  /**
  ...
  /**
    ...
    */
  var `text-decoration-thickness`: js.UndefOr[TextDecorationThicknessProperty[TLength]] = js.undefined
  /**
    * The **`text-decoration-thickness`** CSS property sets the thickness, or width, of the decoration line that is used on text in an element, such as a line-through, underline, or overline.
    *
    * **Initial value**: `auto`
    ...
    * @see https://developer.mozilla.org/docs/Web/CSS/text-decoration-thickness
    */
  var `text-decoration-width`: js.UndefOr[TextDecorationThicknessProperty[TLength]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var `text-underline-offset`: js.UndefOr[TextUnderlineOffsetProperty[TLength]] = js.undefined
  /**
