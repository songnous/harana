package com.harana.ui.external.code_content_loader
...
@js.native
object ReactCodeContentLoader extends js.Object

@react object CodeContentLoader extends ExternalComponent {
  ...
  override val component = ReactCodeContentLoader
}