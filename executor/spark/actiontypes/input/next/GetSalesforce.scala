...
import com.harana.sdk.backend.models.designer.flow.actiontypes.input.next.GetSalesforceInfo
...
class GetSalesforce extends GetSalesforceInfo with ActionType {
