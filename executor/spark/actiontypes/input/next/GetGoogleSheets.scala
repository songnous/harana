...
import com.harana.sdk.backend.models.designer.flow.actiontypes.input.next.GetGoogleSheetsInfo
...
class GetGoogleSheets extends GetGoogleSheetsInfo with ActionType {
