...
import com.harana.sdk.backend.models.flow.actiontypes.input.next.GetGoogleAnalyticsInfo
import com.harana.sdk.backend.models.flow.execution.ExecutionError
import com.harana.executor.spark.actiontypes.dataSourceParameterValues
import zio.{IO, UIO}

class GetGoogleAnalytics extends GetGoogleAnalyticsInfo with Action {
