...
import com.harana.sdk.backend.models.designer.flow.actiontypes.input.next.GetClickhouseInfo
import com.harana.executor.spark.actiontypes.dataSourceParameterValues
import zio.{IO, UIO}

class GetClickhouse extends GetClickhouseInfo with ActionType {
