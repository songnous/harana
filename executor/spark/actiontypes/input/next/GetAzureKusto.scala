...
import com.harana.sdk.backend.models.designer.flow.actiontypes.input.next.GetAzureKustoInfo
import com.harana.executor.spark.actiontypes.dataSourceParameterValues
import zio.{IO, UIO}

class GetAzureKusto extends GetAzureKustoInfo with ActionType {
