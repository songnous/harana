...
import com.harana.sdk.backend.models.designer.flow.actiontypes.input.next.GetGreenplumInfo
...
class GetGreenplum extends GetGreenplumInfo with ActionType {
  ...
  def execute(inputs: Inputs, parameters: ParameterValues, context: FlowContext): IO[ExecutionError, Option[Outputs]] = {
    ...
    val partitionColumn = Parameter.String("partitionColumn")
    val partitionsParameter = Parameter.Integer("partitions")
