...
import com.harana.sdk.backend.models.designer.flow.actiontypes.transform.{MergeInfo, RepartitionInfo}
...
class Repartition extends RepartitionInfo with ActionType {
