...
import com.harana.sdk.backend.models.designer.flow.actiontypes.output.next.PutSalesforceInfo
...
class PutSalesforce extends PutSalesforceInfo with ActionType {
