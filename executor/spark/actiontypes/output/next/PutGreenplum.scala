...
import com.harana.sdk.backend.models.designer.flow.actiontypes.output.next.PutGreenplumInfo
...
class PutGreenplum extends PutGreenplumInfo with ActionType {
