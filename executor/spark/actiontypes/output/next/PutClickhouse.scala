...
import com.harana.sdk.backend.models.designer.flow.actiontypes.output.next.PutClickhouseInfo
...
class PutClickhouse extends PutClickhouseInfo with ActionType {
