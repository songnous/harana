...
import com.harana.sdk.backend.models.designer.flow.actiontypes.output.next.PutGoogleSheetsInfo
...
class PutGoogleSheets extends PutGoogleSheetsInfo with ActionType {
