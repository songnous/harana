...
import com.harana.sdk.backend.models.designer.flow.actiontypes.output.next.PutCouchbaseInfo
...
class PutCouchbase extends PutCouchbaseInfo with ActionType {
