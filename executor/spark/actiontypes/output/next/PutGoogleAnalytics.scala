...
import com.harana.sdk.backend.models.designer.flow.actiontypes.output.next.PutGoogleAnalyticsInfo
...
class PutGoogleAnalytics extends PutGoogleAnalyticsInfo with ActionType {
