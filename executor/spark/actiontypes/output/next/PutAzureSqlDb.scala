...
import com.harana.sdk.backend.models.designer.flow.actiontypes.output.next.PutAzureSqlDbInfo
...
class PutAzureSqlDb extends PutAzureSqlDbInfo with ActionType {
