...
import com.harana.sdk.backend.models.designer.flow.actiontypes.output.next.PutGoogleSpannerInfo
...
class PutGoogleSpanner extends PutGoogleSpannerInfo with ActionType {
