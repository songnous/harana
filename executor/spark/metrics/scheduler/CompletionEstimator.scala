...
import com.harana.executor.spark.metrics.{common, helper, timespan}
...
object CompletionEstimator {
  ...
  def estimateJobWallClockTime(jobTimeSpan: timespan.JobTimeSpan, executorCount: Int, perExecutorCores: Int): Long = {
    ...
    val maxStageID = jobTimeSpan.stageMap.keys.max
   ...
   */
  def estimateJobListWallClockTime(jobTimeSpans: List[timespan.JobTimeSpan], executorCount: Int, perExecutorCores: Int): Long = {
  ...
  def estimateAppWallClockTime(ac: common.AppContext, executorCount: Int, perExecutorCores: Int, appRealDuration: Long): Long = {
  ...
  /**
    ...
    * @return
    */
  def estimateAppWallClockTimeWithJobLists(ac: common.AppContext, executorCount: Int, perExecutorCores: Int, appRealDuration: Long): Long = {
    val appTotalTime = appRealDuration
    val jobGroupsList = helper.JobOverlapHelper.makeJobLists(ac)
