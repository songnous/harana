...
class NTLMEngine {
    ...
    static String getResponseFor(final String message, final String username, final String password,
                                 final String host, final String domain) throws Exception {
     ...
     */
    static String getType1Message(final String host, final String domain) throws Exception {
    ...
    private static int readULong(final byte[] src, final int index) throws Exception {
    ...
    private static int readUShort(final byte[] src, final int index) throws Exception {
    ...
    private static byte[] readSecurityBuffer(final byte[] src, final int index) throws Exception {
    ...
    static byte[] ntlm2SessionResponse(final byte[] ntlmHash, final byte[] challenge,
                                       final byte[] clientChallenge) throws Exception {
        try {
     ...
     */
    private static byte[] ntlmHash(final String password) throws Exception {
     ...
     */
    private static byte[] lmResponse(final byte[] hash, final byte[] challenge) throws Exception {
        try {
    ...
    static class NTLMMessage {
        ...
        NTLMMessage(final String messageBody, final int expectedType) throws Exception {
        ...
        byte readByte(final int position) throws Exception {
        ...
        void readBytes(final byte[] buffer, final int position) throws Exception {
        ...
        int readUShort(final int position) throws Exception {
            return NTLMEngine.readUShort(messageContents, position);
        }

        /** Read a ulong from a position within the message buffer */
        int readULong(final int position) throws Exception {
            return NTLMEngine.readULong(messageContents, position);
        }

        /** Read a security buffer from a position within the message buffer */
        byte[] readSecurityBuffer(final int position) throws Exception {
    ...
    static class Type1Message extends NTLMMessage {
        ...
        Type1Message(final String domain, final String host) throws Exception {
            super();
            if (UNICODE_LITTLE_UNMARKED == null) {
                throw new Exception("Unicode not supported");
            }
    ...
    static class Type2Message extends NTLMMessage {
        ...
        Type2Message(final String message) throws Exception {
            super(message, 2);
    ...
    static class HMACMD5 {
        ...
        HMACMD5(final byte[] input) throws Exception {
            byte[] key = input;
            try {
    ...
    public String generateType1Msg(
            final String domain,
            final String workstation) throws Exception {
