...
object S3ErrorCode extends IntEnum[S3ErrorCode] {
  ...
  case object INVALID_RANGE extends S3ErrorCode(15, 416, "The requested range is not satisfiable")
  case object INVALID_PART extends S3ErrorCode(16, 400, "One or more of the specified parts could not be found. The part may not have been uploaded, or the specified entity tag may not match the part's entity tag.")
  case object INVALID_REQUEST extends S3ErrorCode(17, 400, "Bad Request")
  case object MALFORMED_X_M_L extends S3ErrorCode(18, 400, "The XML you provided was not well-formed or did not validate against our published schema.")
  case object MAX_MESSAGE_LENGTH_EXCEEDED extends S3ErrorCode(19, 400, "Your request was too big.")
  case object METHOD_NOT_ALLOWED extends S3ErrorCode(20, 405, "Method Not Allowed")
  case object MISSING_CONTENT_LENGTH extends S3ErrorCode(21, 411, "Length Required")
  case object NO_SUCH_BUCKET extends S3ErrorCode(22, 404, "The specified bucket does not exist.")
  case object NO_SUCH_KEY extends S3ErrorCode(23, 404, "The specified key does not exist.")
  case object NO_SUCH_POLICY extends S3ErrorCode(24, 404, "The specified bucket does not have a bucket policy.")
  case object NO_SUCH_UPLOAD extends S3ErrorCode(25, 404, "Not Found")
  case object NOT_IMPLEMENTED extends S3ErrorCode(26, 501, "A header you provided implies functionality that is not implemented.")
  case object PRECONDITION_FAILED extends S3ErrorCode(27, 412, "At least one of the preconditions you specified did not hold.")
