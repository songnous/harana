...
"""
    Generator of Scala code for Actions and ActionObjects.
    Used to generate files in graph library:
      * com.harana.flow.Actions
      * com.harana.flow.ActionObjects
"""

import sys
import textwrap

operable_class = "ActionObject"
...
def knowledge_from_context(i, pass_type_tag):
  ...
  return ("{knowledge_class}({infer_context_name}" +\
            ".actionObjectCatalog.concreteSubclassesInstances[{pref}{i}]{additional_arg})")\
