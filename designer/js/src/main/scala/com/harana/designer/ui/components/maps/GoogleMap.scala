	package com.harana.ui.components.maps
...
@react class GoogleMap extends StatelessComponent {
	...
	case class Props(name: String,
									 ...
									 markers: List[Marker] = List.empty)
...
case object MapTypeControlSize extends Enum[MapTypeControlSize] with CirceEnum[MapTypeControlSize] {
	...
	case object Menu extends MapTypeControlSize
	val values = findValues
}
